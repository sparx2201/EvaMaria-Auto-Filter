...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>{file_name} » [{file_size}]</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b><i>{file_name} » {file_size}</i></b>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>𝖳𝗂𝗍𝗅𝖾:</b> <a href={url}>{title}</a> \n<b>𝖸𝖾𝖺𝗋:</b> {year} \n<b>𝖱𝖺𝗍𝗂𝗇𝗀𝗌:</b> {rating}/ 10 \n<b>𝖦𝖾𝗇𝖾𝗋𝗌:</b> {genres} \n\n𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [PirecyKings](https://t.me/PirecyKings)")
